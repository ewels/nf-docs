...
class HTMLRenderer(BaseRenderer):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            include_generation_info: Whether to show the generation timestamp
                in the page footer, which is the only part of the page that
                changes between runs. The "generated by nf-docs vX"
    ...
    def _render(
        ...
        *,
        ...
        # Get generation metadata. The attribution and the nf-docs version are
        # the same on every run, so only the timestamp is dropped when the
        # caller wants reproducible output.
